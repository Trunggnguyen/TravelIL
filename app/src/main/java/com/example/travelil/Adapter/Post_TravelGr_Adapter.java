...
public class Post_TravelGr_Adapter extends  RecyclerView.Adapter<Post_TravelGr_Adapter.ViewHolder>{
    ...
    public Post_TravelGr_Adapter(Context context, ArrayList<GroupTravel> groupTravels, ArrayList<String> key) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_travelgr, parent, false);
        return new Post_TravelGr_Adapter.ViewHolder(view);
    }
