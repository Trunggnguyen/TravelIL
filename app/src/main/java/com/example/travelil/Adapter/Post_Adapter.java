...
import com.example.travelil.Activity.Home.Post_DetailActivity;
...
public class Post_Adapter extends  RecyclerView.Adapter<Post_Adapter.ViewHolder>{
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.post_iteam, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.imageView_post.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent = new Intent(context, Post_DetailActivity.class);
                intent.putExtra("postid",post.getPostid());
                context.startActivity(intent);
            }
        });
      ...
      //  DatabaseReference reference = FirebaseDatabase.getInstance().getReference().child("Likes").child(postid);
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                comment.setText("View all "+ snapshot.getChildrenCount() + " comments");
