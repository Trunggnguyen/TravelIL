...
public class Place_Adapter extends RecyclerView.Adapter<Place_Adapter.Viewholder> {
    ...
    public Place_Adapter(Context context, ArrayList<PlaceAdd> listIdPlaces) {
    ...
    public Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.itemplace_add,parent,false);
    ...
    public void onBindViewHolder(@NonNull Viewholder holder, int position) {
                ...
                Glide.with(context).load(placeAdd.getImageavata11()).into(holder.imageViewplace);
